...
def main(): 
    ...
    mass = float(input("Insert the mass of a chemical sample in grams: "))
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list: 
        element[SYMBOL_INDEX], element[ATOMIC_MASS_INDEX]
        symbol = element[SYMBOL_INDEX]
        quantity = element[ATOMIC_MASS_INDEX]
        

        # Get the atomic mass for the symbol from the dictionary.
        atomic_mass = periodic_table_dict[symbol][ATOMIC_MASS_INDEX]
        # Multiply the atomic mass by the quantity.
        molar_mass_contribution = atomic_mass * quantity
        # Add the product into the total molar mass.
        total_molar_mass = total_molar_mass + molar_mass_contribution    
